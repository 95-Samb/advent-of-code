...
describe SeatingSystem do
  ...
  context "#find_visibles" do
    ...
    it "returns [#,#,#,#,#,#,#,#] for subject" do
      expect(SeatingSystem.new(subject).find_visibles([4,3])).
      to eq(["#","#","#","#","#","#","#","#"])
    end
    ...
    it "returns [#,#,#,#,#,#,#,#] for subject" do
      expect(SeatingSystem.new(subject2).find_visibles([3,3])).
      to eq([])
    end
  end

  context "#apply_new_rules" do
    ...
    it "returns #{answer} for #{subject}"  do
      expect(SeatingSystem.new(subject).apply_new_rules).
      to eq(answer)
    end

  end

  context "#new_solve_seating" do
    ...
    it "returns #{answer} for #{subject}"  do
      expect(SeatingSystem.new(subject).new_solve_seating).
      to eq(answer)
    end
  end
